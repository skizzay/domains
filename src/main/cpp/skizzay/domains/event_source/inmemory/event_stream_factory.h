...
#include <skizzay/domains/event_source/inmemory/event_stream.h>
...
template<typename Event, typename CommitIdProvider, typename CommitTimestampProvider, typename Mutex=std::mutex>
