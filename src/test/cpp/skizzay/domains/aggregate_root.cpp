...
using event_stream_sequence_type = sequence<struct test, int>;
using event_stream_timestamp_type = std::chrono::high_resolution_clock::time_point;

struct test_event_a : tagged_event<test_event_a, event_stream_id_type, event_stream_sequence_type, event_stream_timestamp_type> {
   using tagged_event<test_event_a, event_stream_id_type, event_stream_sequence_type, event_stream_timestamp_type>::tagged_event;
};

struct test_event_b : tagged_event<test_event_b, event_stream_id_type, event_stream_sequence_type, event_stream_timestamp_type> {
   using tagged_event<test_event_b, event_stream_id_type, event_stream_sequence_type, event_stream_timestamp_type>::tagged_event;
};

struct test_event_c : tagged_event<test_event_c, event_stream_id_type, event_stream_sequence_type, event_stream_timestamp_type> {
   using tagged_event<test_event_c, event_stream_id_type, event_stream_sequence_type, event_stream_timestamp_type>::tagged_event;
};
